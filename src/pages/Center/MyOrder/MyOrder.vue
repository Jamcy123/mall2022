    ...
    <div class="order-content">
      ...
      <div class="orders">
        <table class="order-item" v-for="record in myOrder.records" :key="record.id">
          ...
          <tbody>
            <tr v-for="(card, index) in record.orderDetailList" :key="card.id">
              <td width="60%">
                <div class="typographic">
                  <img :src="card.imgUrl" style="width:100px">
                  <a href="#" class="block-text">{{ card.skuName }}</a>
                  <span>x1</span>
                  <a href="#" class="service">售后申请</a>
                </div>
              </td>
              <td :rowspan="record.orderDetailList.length" width="8%" class="center" v-show="index === 0">{{
                  record.consignee
              }}</td>
              <td :rowspan="record.orderDetailList.length" width="13%" class="center" v-show="index === 0">
                <ul class="unstyled">
